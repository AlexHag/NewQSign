...
//     {
//         _context = context;
//         BlobContainerClient = new BlobContainerClient("DefaultEndpointsProtocol=https;AccountName=qsignstorage;AccountKey=qQUn/H9wlTZmR2JnzXMkLtO4dUA3TsImr8GEEK46g2nNUYt+zcyMxuNRSc4rl2UK87yPV26dpct5+ASt+qGaQA==;EndpointSuffix=core.windows.net", "qsigndocuments");
//     }
...
//             Hash = Hash,
//             SubjectUserId = _user.FirstOrDefault().PublicId
//         };
...
//                         .Where(p => p.SubjectUserId == _user.PublicId)
